...
export const MENU_CATEGORIES: MenuCategory[] = [
  {
    ...
    items: [
      ...
      { name: 'Paneer Popcorn', description: 'KFC style snack, deep fried paneer coated with seasoned corn flour', tags: ['M', 'OJ'] },
      { name: 'Falafel', description: 'Deep fried balls made with ground chickpeas, herbs & spices', tags: ['V'] },
      { name: 'Kurkuri Bhindi Fry', description: 'Thinly sliced okra coated with besan and spices, deep fried crispy', tags: ['V', 'OJ'] },
      { name: 'Cabbage Pakora', description: 'Deep fried fritters made from cabbage, gram flour, and rice flour', tags: ['V', 'OJ'] },
      ...
      { name: 'Plain Chips / French Fries', description: 'Classic crispy golden fried potato chips', tags: ['V', 'OJ'] },
      ...
      { name: 'Crispy Bajia', description: 'Crisp seasoned fritters served with authentic chutney', tags: ['V', 'OJ'] },
      { name: 'Plain Mogo', description: 'Mogo is fried, dipped and sprinkled with salt & pepper', tags: ['V', 'OJ'] },
      ...
      { name: 'Crispy Vegetables', description: 'Variety of vegetables dipped in batter and fried, like pakoras', tags: ['V', 'OJ'] },
      ...
      { name: 'Paneer-65', description: 'Homemade cottage cheese dipped in batter and fried like pakoras', tags: ['M', 'OJ'] },
      { name: 'Gobi-65', description: 'Cauliflower dipped in batter and fried, like pakoras', tags: ['V', 'OJ'] },
      ...
      { name: 'Baby Corn-65', description: 'Baby corn dipped in batter and fried, like pakoras', tags: ['V', 'OJ'] },
      ...
      { name: 'Plain Papad', description: 'Crisp and light roasted or fried lentil crackers', tags: ['V', 'OJ'] },
      ...
      { name: 'Paneer Bajji', description: 'Homemade cottage cheese slices pieces dipped in gram flour batter and fried', tags: ['M', 'OJ'] },
      { name: 'Punugulu', description: 'Deep fried balls made with rice, lentils, onions, ginger & chilis served with chutney', tags: ['V'] },
      { name: 'Idli Fingers', description: 'Idly fingers deep fried with a generous sprinkle of spice powder', tags: ['V', 'OJ'] },
      ...
      { name: 'Spicy Cheese Balls', description: 'Cheese & potato smashed with a touch of chili flakes, made balls deep fried', tags: ['M', 'OJ'] },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Pani Puri', description: 'Crunchy puris, potatoes & onions served with sweet & spicy hot flavored water', tags: ['V', 'OJ'] },
      { name: 'Sev Puri', description: 'Puris stuffed with potatoes and onions & topped with combination of our chutneys and crispy sev', tags: ['V', 'OJ'] },
      { name: 'Papri Chaat', description: 'Flour crackers topped with potatoes & chickpeas with yogurt and combination of chutneys', tags: ['M', 'V', 'OJ'] },
      ...
      { name: 'Cheese Puri', description: 'Crunchy puris topped with potatoes, onion, sev, melted cheese and garnished', tags: ['M', 'OJ'] },
      { name: 'Fruit Chat', description: 'Combination of fresh seasonal fruits topped with delicious chaat masala and chutney', tags: ['V', 'OJ'] },
      { name: 'Bhel Puri', description: 'Rice puffs with onions, tomatoes with a mix of delicious tangy chutneys', tags: ['V', 'OJ'] },
      { name: 'Dahi Puri', description: 'Dollar sized puris stuffed with potatoes, onion topped with yogurt, chutneys and sev', tags: ['M', 'V', 'OJ'] },
      ...
      { name: 'Corn Bhel', description: 'Rice puffs, onions, tomatoes served with boiled sweet corn & garnished with sev', tags: ['V', 'OJ'] },
      { name: 'Dal Kachori', description: 'Puris made with combinations of dals and spices served with delicious chutney', tags: ['V', 'OJ'] },
  ...
  },
  {
    ...
    items: [
      { name: 'Tomato Soup', description: 'Clear tomato soup with a dash of pepper', tags: ['V', 'OJ'] },
      ...
      { name: 'Pumpkin Soup', description: 'Velvety roasted pumpkin puree soup garnished with herbs and mild spices', tags: ['V', 'OJ'] },
      ...
      { name: 'Almond Soup', description: 'Velvety soup made with milk, ground almonds and a dash of pepper', tags: ['M', 'N', 'OJ'] },
      ...
      { name: 'Original Tomato Soup', description: 'Traditional tomato soup slow-simmered and flavored with herbs', tags: ['V', 'OJ'] },
      ...
      { name: 'Yellow Moong Dal Soup', description: 'Light and comforting clear soup made with steamed yellow moong dal', tags: ['V', 'OJ'] },
  ...
  },
  {
    ...
    items: [
      { name: 'Naan (1pc)', description: 'Soft, fluffy Indian flatbread baked in a tandoor', tags: ['M', 'OJ'] },
      { name: 'Butter Naan (1pc)', description: 'Soft tandoor-baked naan brushed with creamy butter', tags: ['M', 'OJ'] },
      ...
      { name: 'Cheese Naan (1pc)', description: 'Tandoor-baked naan stuffed with melted cheese', tags: ['M', 'OJ'] },
      { name: 'Chilli Cheese Naan (1pc)', description: 'Soft naan filled with melted cheese and sprinkled with green chilies', tags: ['M', 'OJ'] },
      { name: 'Tandoori Roti (1pc)', description: 'Whole wheat flatbread baked in a tandoor', tags: ['V', 'OJ'] },
      { name: 'Butter Tandoori Roti (1pc)', description: 'Tandoor-baked whole wheat flatbread brushed with creamy butter', tags: ['M', 'OJ'] },
      { name: 'Butter Tawa Roti (1pc)', description: 'Whole wheat flatbread cooked on a tawa and brushed with butter', tags: ['M', 'OJ'] },
      { name: 'Tawa Roti / Tawa Chapathi (1pc)', description: 'Lightly cooked whole wheat flatbread on a tawa', tags: ['V', 'OJ'] },
      { name: 'Tawa Aloo Paratha (1pc)', description: 'Whole wheat flatbread stuffed with spiced mashed potatoes', tags: ['V', 'O', 'J'] },
      { name: 'Tawa Veg Paratha (1pc)', description: 'Whole wheat flatbread stuffed with a mix of spiced vegetables', tags: ['V', 'O', 'J', 'OJ'] },
      ...
      { name: 'Extra Poori (1pc)', description: 'Light, puffed, deep-fried bread', tags: ['V', 'OJ'] },
  ...
  },
  {
    ...
    items: [
      { name: 'Gulab Jamoon', description: 'Soft golden milk dumplings fried and soaked in warm rose and cardamom syrup', tags: ['M', 'OJ'] },
      { name: 'Rasmalai', description: 'Delicate cottage cheese patties soaked in chilled, saffron and cardamom flavored creamy milk', tags: ['M', 'N', 'OJ'] },
      { name: 'Gajar Ka Halwa', description: 'Traditional slow-cooked dessert made with grated carrots, milk, ghee, mawa and dry fruits', tags: ['M', 'N', 'OJ'] },
      { name: 'Sooji Ka Halwa', description: 'Warm, buttery semolina pudding cooked with pure ghee, sugar, cardamom, and roasted nuts', tags: ['M', 'N', 'OJ'] },
      { name: 'Pineapple Sheera', description: 'Aromatic semolina halwa cooked with ghee, juicy pineapple chunks, and saffron', tags: ['M', 'N', 'OJ'] },
      { name: 'Vermicelli Kheer', description: 'Classic sweet dessert of roasted vermicelli simmered in sweetened cardamom milk with nuts', tags: ['M', 'N', 'OJ'] },
      { name: 'Rice Kheer', description: 'Slow-simmered basmati rice pudding infused with saffron, cardamom and topped with slivered nuts', tags: ['M', 'N', 'OJ'] },
      { name: 'Beetroot Halwa', description: 'Vibrant and rich dessert made with grated fresh beetroot, milk, ghee, and roasted cashews', tags: ['M', 'N', 'OJ'] },
    ],
  },
];
